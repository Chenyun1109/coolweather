...
import jz.bd.cy.coolweather.gson.Forecast;
import jz.bd.cy.coolweather.gson.Weather;
import jz.bd.cy.coolweather.service.AutoUpdateService;
import jz.bd.cy.coolweather.util.HttpUtil;
import jz.bd.cy.coolweather.util.Utility;
import okhttp3.Call;
